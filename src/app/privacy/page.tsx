  ...
  return (
    <Container>
      ...
      <section className="mt-10 space-y-4 leading-relaxed">
        <h2 className="text-lg font-bold">個人情報の取得について</h2>
      ...
      <section className="mt-10 space-y-4 leading-relaxed">
        <h2 className="text-lg font-bold">個人情報の第三者提供について</h2>
        <p>当サイトは、法令に基づく場合を除き、ご本人の同意なく個人情報を第三者に提供することはありません。</p>
      </section>

      <section className="mt-10 space-y-4 leading-relaxed">
        <h2 className="text-lg font-bold">個人情報の開示・訂正・削除について</h2>
        <p>
      ...
      <section className="mt-10 space-y-4 leading-relaxed">
        <h2 className="text-lg font-bold">お問い合わせ窓口</h2>
        <p>
